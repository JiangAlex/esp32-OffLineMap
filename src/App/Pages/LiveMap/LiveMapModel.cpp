...
void LiveMapModel::GetGPS_Info(HAL::GPS_Info_t* info)
{
    ...
    if (!info->isVaild)
    {
        ...
        {
            // Force Beijing coordinates for testing with Beijing map data
            info->longitude = 116.38;  // Beijing longitude
            info->latitude = 39.92;    // Beijing latitude
            
            printf("[Model] Force Beijing coordinates for map testing\n");
