...
void WaveTable::onViewLoad()
{
    ...
    AttachEvent(View.ui.btnH.btn); // 添加事件回调*/
}
...
void WaveTable::onViewDidAppear()
{
    ...
    // Re-setup encoder group when returning to WaveTable
    printf("WaveTable: onViewDidAppear - Calling ResetEncoderGroup\n");
    View.ResetEncoderGroup();
